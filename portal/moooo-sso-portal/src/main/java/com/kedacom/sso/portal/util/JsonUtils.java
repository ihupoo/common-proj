...
public class JsonUtils {
	 ...
	 * @return
	 */
	public static <T> Object getDTO(Object jsonString, Class<T> clazz) {
	 ...
	 * @return
	 */
	public static <T> Object getDTO(String jsonString, Class<T> clazz, Map<String, T> map) {
		JSONObject jsonObject = null;
		try {
			setDataFormat2JAVA();
			jsonObject = JSONObject.fromObject(jsonString);
	 ...
	 * @return
	 */
	public static <T> Object[] getDTOArray(String jsonString, Class<T> clazz, Map<String, T> map) {
		setDataFormat2JAVA();
		JSONArray array = JSONArray.fromObject(jsonString);
		Object[] obj = new Object[array.size()];
		for (int i = 0; i < array.size(); i++) {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static <T> List<T> getDTOList(String jsonString, Class<T> clazz, Map<String, T> map) {
		setDataFormat2JAVA();
		JSONArray array = JSONArray.fromObject(jsonString);
		List<T> list = new ArrayList<T>();
		for (Iterator iter = array.iterator(); iter.hasNext();) {
