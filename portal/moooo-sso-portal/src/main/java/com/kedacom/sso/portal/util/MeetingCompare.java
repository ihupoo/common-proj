 ...
 *
 */
public class MeetingCompare<T> implements Comparator<T> {
	private static Logger logger = LoggerFactory.getLogger(MeetingCompare.class);
    private String  propertyName;
    private boolean isAsc;
 
    public MeetingCompare(String propertyname, boolean isasc) {
