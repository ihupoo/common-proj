...
jQuery.fn.extend( {
	...
	live:function( types, data, fn){
		migrateWarn( "jQuery.fn.live() has been removed " );
		var selector = this.selectObj;
		if(selector && selector instanceof Array){
			if(selector[0] && selector[1]){
				$(selector[1]).on( types, selector[0], data, fn );
			}else{
				$(document).on( types, selector[0], data, fn );
			}
		}else{
	...
	die:function( types, fn){
		migrateWarn( "jQuery.fn.die() has been removed " );
		return this.off( types, null, fn );
	}
} );
